...
import com.meazza.instagram.ui.add_post.filter.FilterListener
import com.zomato.photofilters.utils.ThumbnailItem
import kotlinx.android.synthetic.main.layout_filter.view.*

class FilterThumbnailAdapter(private val listener: FilterListener) :
    ...
    class HolderThumbnail(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bindView(item: ThumbnailItem, listener: FilterListener) = itemView.run {
